...
import Login, { LoginPage } from './index';
...
describe('Testing page login', () => {
    ...
    //     email.simulate(
    //         'change',
    //         { target: { value: 'irfan@test.co' } }
    //     );

    //     /**
    //      * On user text password
    //      */
    //     password.simulate(
    //         'change',
    ...
    //     const fooSpy = jest.spyOn(AuthService, 'login');
